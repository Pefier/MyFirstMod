 ...
 */
public class CraftingSurfaceShapedRecipes implements IRecipe {
    ...
    public CraftingSurfaceShapedRecipes(int width, int height, ItemStack[] p_i1917_3_, ItemStack output)
    {
